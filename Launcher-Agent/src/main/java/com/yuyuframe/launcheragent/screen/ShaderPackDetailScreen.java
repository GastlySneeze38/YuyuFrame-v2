...
/**
 * Écran de détail d'un shader pack Modrinth — copie de ResourcePackDetailScreen
 * adaptée au dossier shaderpacks. Voir ce fichier pour les commentaires
 * détaillés (non répétés ici).
 */
public class ShaderPackDetailScreen extends Screen {
    ...
    public ShaderPackDetailScreen(Object lastScreen, ModrinthJson.Hit hit, Path shaderPacksDir) {
    ...
    private boolean isAlreadyInstalled() {
        ...
        try {
            ...
            LauncherLog.warn("[LauncherAgent-Screen] isAlreadyInstalled (shader): " + e);
            return false;
        }
    }
    ...
    private void doInstall() {
        try {
            ...
            LauncherLog.err("[LauncherAgent-Screen] doInstall (shader detail): " + t);
